...
import { DetailSOPPenyusunHeader } from '@/pages/sop/detail/components/DetailSopPenyusunHeader'
...
function renderHeader(
  ...
  const props: React.ComponentProps<typeof DetailSOPPenyusunHeader> = {
    ...
    currentSopStatusLabel: 'Rancangan',
...
describe('DetailSOPPenyusunHeader', () => {
  ...
  it('menjadikan identitas SOP sebagai fokus command bar', () => {
    ...
    expect(screen.getByText('Rancangan')).toBeInTheDocument()
