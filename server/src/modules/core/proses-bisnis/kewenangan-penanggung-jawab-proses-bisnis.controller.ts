...
import { GrantKewenanganPenanggungJawabProsesBisnisDto } from './dto/penanggung-jawab-proses-bisnis.dto';
...
@Controller('administrasi-proses-bisnis/owner-authorities')
