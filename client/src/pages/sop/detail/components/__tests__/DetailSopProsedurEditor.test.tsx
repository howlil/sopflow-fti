...
vi.mock('@/pages/sop/hooks/use-prosedur-editor', () => ({
  useProsedurEditor: () => ({
...
vi.mock('@/pages/sop/detail/components/DecisionStepDialog', () => ({
  DecisionStepDialog: () => null,
}))

import { DetailSOPProsedurEditor } from '@/pages/sop/detail/components/DetailSopProsedurEditor'
...
describe('DetailSOPProsedurEditor', () => {
  ...
  it('mempertahankan aksi tambah langkah dan selesai edit', () => {
    ...
    fireEvent.click(screen.getByRole('button', { name: 'Selesai mengubah' }))
