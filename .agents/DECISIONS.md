...
2. **Authorization axes are separate.** `PlatformRole` controls platform administration; ProsesBisnis relationships control authoring/review; organizational authority controls final approval/TTE.
